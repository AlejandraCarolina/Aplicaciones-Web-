                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('proveedores.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="nombre_contacto" name="nombre_contacto" class="w-full border-gray-300 rounded" required>
                        </div>
                        <div class="mb-4">
                            <label for="correo" class="block text-gray-700 font-bold">Correo Electrónico:</label>
                            <input type="email" id="correo" name="correo" class="w-full border-gray-300 rounded" required>
                        </div>
                        <div class="mb-4">
