                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('compras.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="precio" name="precio" class="w-full border-gray-300 rounded" required>
                        </div>
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="descuento" name="descuento" class="w-full border-gray-300 rounded" required>
                        </div>
